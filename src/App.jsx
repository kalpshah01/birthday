...
const COLORS = [
  { name:'red',    hex:'#ff4d4d', btnColor:'#ff2d55', heartHex:'#ffb3ba', bg:'linear-gradient(135deg,#ff2d55 0%,#ff6b6b 50%,#ffb3ba 100%)', image:'red.png',    emoji:'❤️',  message:'❤️ Red — bold, fearless, and beautiful. You are a true fighter,! 🌹' },
 
  { name:'yellow', hex:'#ffd93d', btnColor:'#e6b800', heartHex:'#ffe066', bg:'linear-gradient(135deg,#f7c948 0%,#ffd700 50%,#fff3a3 100%)', image:'yellow.png', emoji:'🌟',  message:'🌟 Yellow — bright like your smile. Hardworking, humble, always shining! 🌻' },
 
  { name:'blue',   hex:'#4d79ff', btnColor:'#2d7fff', heartHex:'#a8d8ff', bg:'linear-gradient(135deg,#2d7fff 0%,#00c6fb 50%,#a8d8ff 100%)', image:'blue.png',   emoji:'💙',  message:'💙 Blue — calm and wonderful. Your quiet strength inspires everyone! 🫐' },
  { name:'purple', hex:'#9b59b6', btnColor:'#7f00ff', heartHex:'#ddb6ff', bg:'linear-gradient(135deg,#7f00ff 0%,#a855f7 50%,#ddb6ff 100%)', image:'purple.png', emoji:'💜',  message:'💜 Purple — royal and magical. Grace and dignity every single day! ✨' },
  // ── Black & White: placeholder SVGs until real photos are added ─────────
  { name:'green',  hex:'#26de81', btnColor:'#11998e', heartHex:'#80ffbb', bg:'linear-gradient(135deg,#11998e 0%,#38ef7d 50%,#b7f5d8 100%)', image:'green.png',  emoji:'💚',  message:'💚 Green — always growing. Every challenge is an opportunity for you! 🍀' },
  { name:'black',  hex:'#1a1a2e', btnColor:'#333366', heartHex:'#d0c0ff', bg:'linear-gradient(135deg,#1a1a2e 0%,#16213e 50%,#0f3460 100%)', image:'black.png',  emoji:'🖤',  message:'🖤 Black — mysterious and elegant. Like the night sky that holds all the stars! 🌙' },
  { name:'white',  hex:'#c8b8e8', btnColor:'#9080c0', heartHex:'#9080c0', bg:'linear-gradient(135deg,#f8f9fa 0%,#e9ecef 50%,#dee2e6 100%)', image:'white.png',  emoji:'🤍',  message:'🤍 White — pure and graceful. Like fresh snow that blankets everything in beauty! ⭐' },
  { name:'orange', hex:'#ff9f43', btnColor:'#f7971e', heartHex:'#ffd18a', bg:'linear-gradient(135deg,#f7971e 0%,#ff6a00 50%,#ffd18a 100%)', image:'orange.png', emoji:'🧡',  message:'🧡 Orange — warm and radiant. Your energy lights up every room! 🌼' },
  {name:'silver', hex:'#bdc3c7', btnColor:'#7f8c8d', heartHex:'#ecf0f1', bg:'linear-gradient(135deg,#7f8c8d 0%,#bdc3c7 50%,#ecf0f1 100%)', image:'silver.png', emoji:'⚪', message:'⚪ Silver — sleek and shining. Like the moonlight that dances on the water! 🌊' },
  { name:'pink',   hex:'#ff66b2', btnColor:'#f953c6', heartHex:'#ffd6e8', bg:'linear-gradient(135deg,#f953c6 0%,#ff85b3 50%,#ffd6e8 100%)', image:'pink.png',   emoji:'🩷',  message:'🩷 Pink — sweet and lovely. Saving the best for last, just like you! 🌸' },
];
    ...
    return (
      <div className="app-root start-screen">
        ...
        <div className="start-content">
          ...
          <h1 className="start-title">Happy Birthday🌟</h1>
    ...
    <div className="app-root main-screen" style={{ background: displayColor.bg }}>
      ...
      <div className={`content-wrapper ${isTransitioning ? 'fading' : ''}`}>
        <header className="site-header">
          ...
          <h1 className="site-title">Happy Birthday 🎂</h1>
